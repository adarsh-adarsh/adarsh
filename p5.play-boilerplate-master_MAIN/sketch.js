...
function car1()
{
  ...
  car1.speed = RandomNumber(70,90);
  car1.weight = RandomNumber(500,800);
}
...
function car2()
{
  ...
  car2.speed = RandomNumber(50,70);
  car2.weight = RandomNumber(800,1100);
}
...
function car3()
{
  ...
  car3.speed = RandomNumber(30,50);
  car3.weight = RandomNumber(1100,1400);
}
